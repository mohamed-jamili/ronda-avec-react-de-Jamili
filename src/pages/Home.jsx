      ...
      <div className="container" style={{ maxWidth: '600px' }}>
        ...
        {viewState === 'menu' && (
            <div className="d-flex flex-column align-items-center gap-3 animate-fade-in">
                <p className="lead fw-light mb-4 text-white opacity-75" style={{maxWidth: '500px'}}>
                  Le jeu de cartes le plus populaire au Maroc !<br/>
                  <strong className="text-warning">Ronda</strong>, <strong className="text-warning">Tringa</strong>, <strong className="text-info">Missa</strong>... Préparez-vous à revivre l'ancien temps.
                </p>
